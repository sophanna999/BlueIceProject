...
class PickupController extends Controller {
    ...
    public function index(){
        ...
        $data['Truck']        = \App\Models\Truck::where('BraID',session('BraID'))->where('user_id','!=',NULL)->get();
    ...
    public function listPickup() {
        ...
        , 'ProductTruck.ProNumber', 'ProUnit', 'ProPrice', 'TruckDate')
        ...
        ->where(['ProductTruck.BraID'=>session('BraID'),'UserID'=>\Auth::user()->id])
