...
class AccountTypeMasterController extends Controller
{
    ...
    {
      $data['title'] = 'กำหนดหมวดบัญชี';
      $data['main_menu'] = 'ตั้งค่า';
      return view('admin.Setting.account_type_master',$data);
    }
    ...
    public function store(Request $request)
    {
      ...
      try {
          ...
          $data_insert = [
              'accountType_name' => $request->accountType_name,
              'created_at' => date('Y-m-d H:i:s'),
          ];
          AccountTypeMaster::insert($data_insert);
          \DB::commit();
          $return['type'] = 'success';
          $return['text'] = 'สำเร็จ';
      } catch (Exception $e){
    ...
    {
      $result = AccountTypeMaster::where('id',$id)->first();
      return $result;
    }
    ...
    public function update(Request $request)
    {
      ...
      try {
          ...
          AccountTypeMaster::where('id',$request->editid)->update($data_update);
          \DB::commit();
          $return['type'] = 'success';
          $return['text'] = 'สำเร็จ';
      } catch (Exception $e){
    ...
    public function destroy($id)
    {
      ...
      \DB::beginTransaction();
      try {
          AccountTypeMaster::where('id',$id)->delete();
          \DB::commit();
          $return['type'] = 'success';
          $return['text'] = 'สำเร็จ';
      } catch (Exception $e) {
    ...
    public function listAccountTypeMaster()
    {
      $result = AccountTypeMaster::select();
