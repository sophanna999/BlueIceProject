...
class WarehouseController extends Controller
{
    ...
    {
      $data['title'] = 'กำหนดคลังสินค้า';
      $data['main_menu'] = 'ตั้งค่า';
      return view('admin.Setting.warehouse',$data);
    }
    ...
    {
      $result = Warehouse::where('id',$id)->first();
      return $result;
    }
    ...
    public function update(Request $request)
    {
      ...
      try {
          ...
          Warehouse::where('id',$request->editid)->update($data_update);
          \DB::commit();
          $return['type'] = 'success';
          $return['text'] = 'สำเร็จ';
      } catch (Exception $e){
